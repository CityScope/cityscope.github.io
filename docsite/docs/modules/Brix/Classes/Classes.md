...
### class brix.Grid_maker(table_name, top_left_lat, top_left_lon, cell_size=100, nrows=20, ncols=20, rotation=0, crs_epsg=None, quietly=False)
...
* **Parameters**
    ...
    * **top_left_lat** (*float*) – Latitude of top left corner of grid


    * **top_left_lon** (*float*) – Longitude of top left corner of grid


    * **cell_size** (*float**, **defaults to 100*) – Lenght in meters of the side of each cell.


    * **nrows** (*int**, **defaults to 20*) – Number of rows


    * **ncols** (*int**, **defaults to 20*) – Number of columns


    * **rotation** (*int**, **defaults to 0*) – Roation of the grid.


    * **crs_epsg** (*str*) – EPSG code for the desired projection.
    Do not include ‘EPSG’
...
* **Parameters**
    ...
    * **i** (*int*) – Index of color (e.g. 0,1,2,3,…,n)


    * **n** (*int*) – Size of palette



* **Returns**

    **color** – RGB code for color
...
* **Parameters**
    ...
    **types** (*dict** or **list*) – Object with new type definitions.
...
#### get_grid_geojson()
Returns the object created with `brix.Grid_maker.set_grid_geojson()`.
If the object has not been created, it will created using the default properties.


* **Returns**

    **geogrid** – Object to be posted to GEOGRID endpoint to create table.
    See `brix.commit_grid()`
...
#### set_grid_geojson(add_properties={}, include_global_properties=True)
...
Use `brix.Grid_maker.get_grid_geojson()` to access it


* **Parameters**

    
    * **add_properties** (*dict** (**optional**)*) – Properties of each type.
    Currently not supported


    * **include_global_properties** (Boolean, defaults to True) – If True it will add global properties to each cell.



#### set_noninteractive(poly)
Sets cells that fall outside of polygon as non interactive.


* **Parameters**

    **poly** (*shapely Polygon*) – Polygon bounding the interactive part of the grid.



#### wgs( = <Other Coordinate Operation Transformer: longlat> Description: PROJ-based coordinate operation Area of Use: - undefined)
